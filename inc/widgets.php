...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'id' => 'sidebar-primary',
    'before_widget' => '<section id="%1$s" class="widget well %2$s"><div class="widget-inner">',
    'after_widget' => '</div></section>',
    'before_title' => '<h3>',
    'after_title' => '</h3>',
  ));
  register_sidebar(array(
    'name' => __('Footer Primary', 'roots'),
    'id' => 'sidebar-footer-pri',
    'before_widget' => '<div class="row"><div class="span4"><section id="%1$s" class="well widget %2$s"><div class="widget-inner">',
    'after_widget' => '</div></section></div></div>',
    'before_title' => '<h3>',
    'after_title' => '</h3>',
  ));
    register_sidebar(array(
    'name' => __('Footer Secondary', 'roots'),
    'id' => 'sidebar-footer-sec',
    'before_widget' => '<div class="row"><div class="span3"><section id="%1$s" class="well widget %2$s"><div class="widget-inner">',
    'after_widget' => '</div></section></div></div>',
    'before_title' => '<h3>',
    'after_title' => '</h3>',
  ));
    register_sidebar(array(
    'name' => __('Footer Third', 'roots'),
    'id' => 'sidebar-footer-thd',
    'before_widget' => '<div class="row"><div class="span3"><section id="%1$s" class="well widget %2$s"><div class="widget-inner">',
    'after_widget' => '</div></section></div></div>',
    'before_title' => '<h3>',
    'after_title' => '</h3>',
