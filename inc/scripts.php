...
function roots_scripts() {
  ...
  wp_register_script('respondJS', get_template_directory_uri() . '/js/respond.min.js', false, null, false);
  wp_register_script('roots_custom', get_template_directory_uri() . '/js/custom.js', false, null, false);
