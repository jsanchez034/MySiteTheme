...
<head>
  ...
  <link rel="stylesheet/less" href="<?php echo get_template_directory_uri(); ?>/css/less/bootstrap.less">
  <link rel="stylesheet/less" href="<?php echo get_template_directory_uri(); ?>/css/less/responsive.less">
